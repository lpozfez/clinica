...
class PacienteApiController extends AbstractController
{
    ...
    //Método para traer las notas clínicas por paciente
    #[Route('/notas/{id}',name:'getNotaspaciente', methods:['GET'])]
    public function getNotasPaciente(int $id, Request $request):JsonResponse
    {
        //Traemos el paciente mediante la id.
       $paciente=$this->repo->find($id);
       if(empty($paciente)){
